...
`200 OK` will be returned along with the JSON of the request form (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/requestforms.md#get-request-form" target="_blank" rel="noopener noreferrer"><u>Get request form</u></a>) if the record is added.
...
`200 OK` will be returned along with the JSON of the request form (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/requestforms.md#get-request-form" target="_blank" rel="noopener noreferrer"><u>Get quickies</u></a>) if the record is updated. `403 Forbidden` will be returned in case of invalid access.
