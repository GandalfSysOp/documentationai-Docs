...
`201 Created` will be returned along with the JSON of the topic (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/topics.md#get-topic" target="_blank" rel="noopener noreferrer"><u>Get topic</u></a>) if the record is added. `403 Forbidden` will be returned in case of invalid access.

**Attaching files**

Attaching files to a topic requires id of the attachment. The id is obtained from the <a href="https://github.com/ProofHub/api_v3/blob/master/sections/attachments.md#create-attachments" target="_blank" rel="noopener noreferrer"><u>Create attachments</u></a> endpoint, which you must hit first before creating an upload. Multiple attachments are allowed.
...
`200 OK` will be returned along with the JSON of the topic (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/topics.md#get-topic" target="_blank" rel="noopener noreferrer"><u>Get topic</u></a>) if the record is updated. `403 Forbidden` will be returned in case of invalid access.
