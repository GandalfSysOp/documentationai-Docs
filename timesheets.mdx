...
`201 Created` will be returned along with the JSON of the timesheet (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/timesheets.md#get-timesheet" target="_blank" rel="noopener noreferrer"><u>Get timesheet</u></a>) if the record is added. `403 Forbidden` will be returned in case of invalid access.
...
`200 OK` will be returned along with the JSON of the timesheet (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/timesheets.md#get-timesheet" target="_blank" rel="noopener noreferrer"><u>Get timesheet</u></a>) if the record is updated. `403 Forbidden` will be returned in case of invalid access.
