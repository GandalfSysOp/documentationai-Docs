...
- Attach the file to a topic, comment, task or file section. See the following endpoints for attaching:
  ...
  - <a href="https://github.com/ProofHub/api_v3/blob/master/sections/topics.md#create-topic" target="_blank" rel="noopener noreferrer"><u>Create topic</u></a>

  - <a href="https://github.com/ProofHub/api_v3/blob/master/sections/tasks.md#create-task" target="_blank" rel="noopener noreferrer"><u>Create task</u></a>

  - <a href="https://github.com/ProofHub/api_v3/blob/master/sections/files.md#create-file" target="_blank" rel="noopener noreferrer"><u>Create file</u></a>
