...
`201 Created` will be returned along with the JSON of the todolist (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/tododlists.md#get-todolist" target="_blank" rel="noopener noreferrer"><u>Get todolist</u></a>) if the record is added. `403 Forbidden` will be returned in case of invalid access.
...
`200 OK` will be returned along with the JSON of the todolist (<a href="https://github.com/ProofHub/api_v3/blob/master/sections/tododlists.md#get-todolist" target="_blank" rel="noopener noreferrer"><u>Get todolist</u></a>) if the record is updated. `403 Forbidden` will be returned in case of invalid access.
